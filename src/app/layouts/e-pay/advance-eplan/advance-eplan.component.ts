...
@Component({
  selector: 'app-advance-eplan',
  templateUrl: './advance-eplan.component.html',
  styleUrls: ['./advance-eplan.component.css']
})
export class AdvanceEPlanComponent implements OnInit {
  planCost = "199";
