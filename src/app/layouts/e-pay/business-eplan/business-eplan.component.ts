...
@Component({
  selector: 'app-business-eplan',
  templateUrl: './business-eplan.component.html',
  styleUrls: ['./business-eplan.component.css']
})
export class BusinessEPlanComponent implements OnInit {
  planCost = "499";
