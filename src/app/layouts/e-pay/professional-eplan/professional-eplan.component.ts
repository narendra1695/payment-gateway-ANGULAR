...
import { PaySService } from 'src/app/services/pay-s.service';
import { environment } from 'src/environments/environment';

@Component({
  selector: 'app-professional-eplan',
  templateUrl: './professional-eplan.component.html',
  styleUrls: ['./professional-eplan.component.css']
})
export class ProfessionalEPlanComponent implements OnInit {
  planCost = "399";
