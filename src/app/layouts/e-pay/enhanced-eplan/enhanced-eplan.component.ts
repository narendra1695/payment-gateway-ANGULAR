...
@Component({
  selector: 'app-enhanced-eplan',
  templateUrl: './enhanced-eplan.component.html',
  styleUrls: ['./enhanced-eplan.component.css']
})
export class EnhancedEPlanComponent implements OnInit {
  planCost = "299";
