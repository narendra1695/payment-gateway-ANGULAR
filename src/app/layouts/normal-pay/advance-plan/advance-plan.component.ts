...
@Component({
  selector: 'app-advance-plan',
  templateUrl: './advance-plan.component.html',
  styleUrls: ['./advance-plan.component.css']
})
export class AdvancePlanComponent implements OnInit {
  planCost = "199";
