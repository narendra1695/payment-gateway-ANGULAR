...
@Component({
  selector: 'app-professional-plan',
  templateUrl: './professional-plan.component.html',
  styleUrls: ['./professional-plan.component.css']
})
export class ProfessionalPlanComponent implements OnInit {
  planCost = "399";
